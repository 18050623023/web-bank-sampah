        ...
        <div class="section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-4">
            <div class="container-fluid">
                <div class="text-center">
                    ...
                    <a class="btn btn-primary px-5 radius-30" href="<?php echo e(route('logout')); ?>"
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--favicon-->
    <link rel="icon" href="<?php echo e(asset('template')); ?>/assets/images/favicon-32x32.png" type="image/png" />
    <!--plugins-->
    <link href="<?php echo e(asset('template')); ?>/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <link href="<?php echo e(asset('template')); ?>/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
    <link href="<?php echo e(asset('template')); ?>/assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        <img src="<?php echo e(asset('template')); ?>/assets/images/logo-img.png" width="140" alt="" />
                    </a>
...
<?php /**PATH C:\xampp\htdocs\bank-sampah\resources\views/home.blade.php ENDPATH**/ ?>