						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
                        <form method="POST" action="<?php echo e(url('admin/storepetugas')); ?>">
                        <?php echo csrf_field(); ?>
									<div class="row mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bank-sampah\resources\views/admin/addpetugas.blade.php ENDPATH**/ ?>