...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="<?php echo e(asset('template')); ?>/assets/images/dlh.png" class="logo-icon" alt="logo icon"
        type="image/png" />
    <!--plugins-->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        <img src="<?php echo e(asset('template')); ?>/assets/images/dlh.png" width="70" alt="" />
...
<?php /**PATH C:\xampp\htdocs\bank-sampah\resources\views/welcome.blade.php ENDPATH**/ ?>