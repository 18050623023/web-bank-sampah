            ...
            <div class="border p-4 rounded">
                ...
                <form method="POST" action="/admin/updatesetoran">
                    ...
                    <div class="row mb-3" hidden>
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="id_storan" class="form-control" id="inputEmailAddress2"
                                value="{{ $setoran->id }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="jml_tab" class="form-control" id="inputEmailAddress2"
                                value="{{ $setoran->jml_tab_pergram }}">
                        </div>
                    </div>

                    @if (auth()->user()->type == 'Admin' || auth()->user()->type == 'Teller')
