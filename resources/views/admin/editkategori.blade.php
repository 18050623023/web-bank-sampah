					...
					<div class="col-xl-9 mx-auto">
                        ...
                        @csrf
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="number" name="point" class="form-control" id="inputEmailAddress3" value="{{ $kategori->point }}">
										</div>
									</div>
                                    <div class="row mb-3">
										<label for="inputEmailAddress4" class="col-sm-3 col-form-label">Satuan/Ton</label>
										<div class="col-sm-9">
											<input type="number" name="ton" class="form-control" id="inputEmailAddress3" value="{{ $kategori->ton }}">
										</div>
									</div>
									<div class="row">
