                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form method="POST" action="{{ url('admin/storenasabah') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" name="email" class="form-control" id="inputEnterYourName"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="nik" class="form-control" id="inputEnterYourName"
                                        placeholder="NIK">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nama_nasabah" class="form-control" id="inputEmailAddress2"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="no_hp" class="form-control" id="inputChoosePassword2"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tempat_lahir" class="form-control" id="inputChoosePassword2"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="alamat" class="form-control" id="inputChoosePassword2"
                                        placeholder="Alamat">
                                </div>
                            </div>
